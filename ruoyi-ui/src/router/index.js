...
export const dynamicRoutes = [
  ...
  },
  {
    ...
    children: [
      {
        path: '',
        component: () => import('@/views/karaoke/manage/player'),
        name: 'KaraokePlayer',
        meta: { title: 'MV播放器', activeMenu: '/karaoke/manage/mvList' }
      }
    ]
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/views/karaoke/singer/index'),
        name: 'KaraokeSinger',
        meta: { title: '歌手管理', icon: 'user' }
      }
    ]
  },
  {
    path: '/karaoke/statistics',
    component: Layout,
    children: [
      {
        path: 'index',
        component: () => import('@/views/karaoke/statistics/index'),
        name: 'KaraokeStatistics',
        meta: { title: 'KTV统计', icon: 'chart' }
      }
    ]
  }
]
